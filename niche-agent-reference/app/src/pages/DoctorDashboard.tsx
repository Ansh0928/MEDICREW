              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-[#0F1A2A]">
          ...
          <TabsContent value="queue">
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-1 space-y-3">
                <h3 className="font-semibold text-[#0F1A2A] mb-3">
                  Waiting Patients
                </h3>
                {queue.length === 0 ? (
                  <Card className="border-[#EAF3FB]">
                  ...
                  queue.map((item) => (
                    <Card
                      ...
                      className={`border-[#EAF3FB] cursor-pointer hover:shadow-md transition-shadow ${
                        selectedCase?.id === item.symptomCheckId
                          ? "ring-2 ring-[#1E6FD9]"
                          : ""
                      }`}
                      onClick={() => {
                        const check = allChecks.find(
                          (c) => c.id === item.symptomCheckId,
                        );
                        ...
                        <div className="flex items-start justify-between">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <div
                                className={`w-2 h-2 rounded-full ${getUrgencyDot(item.urgencyLevel)}`}
                              />
                  ...
                  <div className="space-y-6">
                    ...
                    <Card className="border-[#EAF3FB]">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Badge
                            className={getUrgencyColor(
                              selectedCase.aiAssessment.urgencyLevel,
                            )}
                          >
                      ...
                      <CardContent className="space-y-4">
                        <div>
                          <Label className="text-sm text-[#5A6B7F]">
                            Symptoms
                          </Label>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#0F1A2A]">
                        ...
                        {aiInsights ? (
                          <>
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2 mt-1">
                                {aiInsights.differentialDiagnosis.map(
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2 mt-1">
                                {aiInsights.recommendedTests.map(
