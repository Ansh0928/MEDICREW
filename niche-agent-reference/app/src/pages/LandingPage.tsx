          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#EAF3FB] rounded-full mb-6">
                ...
                <span className="text-sm font-medium text-[#1E6FD9]">
              ...
              <p className="text-lg text-[#5A6B7F] mb-8 max-w-lg">
                Reduce wait times, improve diagnostic accuracy, and deliver
                better patient outcomes with clinically-validated AI technology.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-6 border border-[#EAF3FB]">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="font-semibold text-[#0F1A2A]">
                      AI Triage Assistant
                    </div>
                ...
                <div className="space-y-3">
                  <div className="bg-[#F6F8FA] rounded-xl p-4">
                    <div className="text-sm font-medium text-[#0F1A2A] mb-1">
                      Patient Symptoms
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {["Headache", "Fever", "Fatigue"].map((symptom) => (
                        <span
                          key={symptom}
                          className="px-3 py-1 bg-white rounded-full text-sm text-[#5A6B7F] border border-[#EAF3FB]"
                        >
                          {symptom}
                        </span>
                      ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#5A6B7F] max-w-2xl mx-auto">
              From AI-powered triage to comprehensive diagnostic tools, HealthAI
              streamlines the entire healthcare journey.
            </p>
          </div>
      ...
      <section className="py-20 bg-[#0F1A2A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
            Join leading hospitals and clinics across Australia using HealthAI
            to deliver better patient outcomes with less wait time.
          </p>
