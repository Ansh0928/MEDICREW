...
let doctorNotes: DoctorNote[] = [
  {
    ...
    treatment:
      "Rest, fluids, acetaminophen for fever and headache. Monitor symptoms.",
    notes:
      "Patient presents with typical viral symptoms. No red flags identified. Recommend follow-up if symptoms persist beyond 7 days.",
