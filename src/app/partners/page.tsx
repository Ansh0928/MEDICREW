...
export const metadata: Metadata = {
  ...
  description:
    "Australia-first pilot program for clinics, allied health teams, and care communities.",
};
    ...
    <>
      ...
      <main className="mx-auto min-h-screen max-w-4xl px-6 pt-28 pb-16">
        ...
        <p className="mt-4 text-slate-700">
          We run limited pilot programs with clinics, allied health
          organizations, and community health groups to validate safe,
          measurable care-navigation workflows.
        </p>
        ...
        <p className="mt-8 text-slate-700">
          Contact:{" "}
          <a className="underline" href="mailto:partners@medicrew.health">
            partners@medicrew.health
          </a>
        </p>
      </main>
      <Footer />
