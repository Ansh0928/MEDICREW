...
export async function POST(request: NextRequest) {
  ...
  const updatedPatient = await prisma.patient.update({
    ...
    data: {
      ...
      medications,
      allergies,
      emergencyContact: emergencyContact !== undefined ? (emergencyContact as Prisma.InputJsonValue) : Prisma.DbNull,
      gpDetails: gpDetails !== undefined ? (gpDetails as Prisma.InputJsonValue) : Prisma.DbNull,
