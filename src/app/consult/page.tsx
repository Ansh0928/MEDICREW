...
export default function ConsultPage() {
  ...
  // Wait for Clerk to resolve before computing href — avoids "/" flash for authed users.
  const backHref = isLoaded && user ? "/patient" : "/";
  const backLabel = isLoaded && user ? "Back to Portal" : "Back to Home";
