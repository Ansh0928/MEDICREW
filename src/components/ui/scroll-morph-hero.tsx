...
const IMAGES = [
  ...
  "https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=300&q=80",
  ...
  "https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?w=300&q=80",
  "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=300&q=80",
  "https://images.unsplash.com/photo-1628348068343-c6a848d2b6dd?w=300&q=80",
  "https://images.unsplash.com/photo-1487956382158-bb926046304a?w=300&q=80",
  ...
  "https://images.unsplash.com/photo-1561489413-985b06da5bee?w=300&q=80",
  "https://images.unsplash.com/photo-1571772996211-2f02c9727629?w=300&q=80",
  "https://images.unsplash.com/photo-1588776814546-1ffbb172d4aa?w=300&q=80",
  ...
  "https://images.unsplash.com/photo-1504813184591-01572f98c85f?w=300&q=80",
  "https://images.unsplash.com/photo-1491895200222-0fc4a4c35e18?w=300&q=80",
      ...
      <div className="flex h-full w-full flex-col items-center justify-center">
        ...
        <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2 px-4">
          ...
          <motion.p
            ...
            className="mt-4 text-xs font-bold tracking-[0.2em] text-white/40 font-[family-name:var(--font-mono)]"
          >
            SCROLL TO EXPLORE
          </motion.p>
        </div>
