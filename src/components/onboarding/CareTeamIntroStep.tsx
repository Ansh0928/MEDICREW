  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-muted-foreground">
        Meet your personal Medicrew care team. Each AI specialist is available
        whenever you need guidance. They work together to give you
        comprehensive, coordinated health support.
      </p>
