...
const stats = [
  {
    ...
    stat: "4–6 weeks",
    label: "Avg. specialist wait time in Australia",
    color: "#118CFD",
  },
  {
    icon: <MapPin className="w-5 h-5" />,
    stat: "7M+",
    label: "Australians with limited specialist access",
    color: "#8470BE",
  },
  {
    icon: <HelpCircle className="w-5 h-5" />,
    stat: "65%",
    label: "Unsure if symptoms need urgent care",
    color: "#12CA93",
  },
  {
    icon: <DollarSign className="w-5 h-5" />,
    stat: "$400+",
    label: "Average out-of-pocket specialist visit",
    color: "#F7C543",
  },
];
...
export function Problem() {
  return (
    <section
      ...
      style={{ background: "linear-gradient(25deg, #EEE8E4, #FDF5E2)" }}
    >
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p
              ...
              style={{ color: "#384248" }}
            >
              Millions of Australians wait weeks or pay hundreds just to
              understand their own symptoms. MediCrew gives you the guidance —
              instantly, for free.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {stats.map((s, i) => (
              ...
              >
                <div className="mb-3" style={{ color: s.color }}>
                  {s.icon}
                </div>
                <div
                ...
                <p
                  className="font-[family-name:var(--font-mono)] text-[11px] leading-snug"
                  style={{ color: "#637288" }}
                >
                  {s.label}
                </p>
